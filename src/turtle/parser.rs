                ...
                (SyntaxKind::MyString, 1usize) => {
                    state.add_element(
                        element
                            ...
                            .push(Rule {
                                kind: SyntaxKind::StringLiteralQuote,
                                state: 0usize,
                            }),
                    );
                    state.add_element(
                        element
                            ...
                            .push(Rule {
                                kind: SyntaxKind::StringLiteralSingleQuote,
                                state: 0usize,
                            }),
                    );
                    state.add_element(
                        element
                            ...
                            .push(Rule {
                                kind: SyntaxKind::StringLiteralLongSingleQuote,
                                state: 0usize,
                            }),
                    );
                    state.add_element(
                        element
                            ...
                            .push(Rule {
                                kind: SyntaxKind::StringLiteralLongQuote,
                                state: 0usize,
                            }),
                    );
                }
